...
Lisäksi sain alustettua projektini Poterylla ja työnnettyä sen GitHubiin luomaani repositorioon.

Seuraavaksi aijon syventää ymmärrystäni RSA:sta ja implementoida satunnaisten alkulukujen luonnin.

## Työtunnit

| päivä | aika | mitä tein |
| :----:|:-----| :---------|
| 1.9. | 1 t | aloitusluento |
| 5.9. | 9 t | aiheen valinta ja perehtymistä sekä määrittelydokumentin ja viikkoraportin kirjoittamista |
|Summa | 10 t |
